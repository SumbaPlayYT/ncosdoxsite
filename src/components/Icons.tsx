...
export const MessageSquare = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ArrowUp = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const GraduationCap = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const HeartPulse = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    ...
    <path d="M3.22 12H7.5l2-4.5 2 7.5 2-4.5 1.5 3.5h3.78" />
  </svg>
);

export const UserCheck = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Dna = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    ...
    <path d="M4 18a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
    <path d="M4 6a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
    <path d="M16 18a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
    <path d="M10 12h4" />
  </svg>
);

export const Factory = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    <path d="M2 20h20" />
    <path d="m5 17 2-3V7a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v7l2 3h-12Z" />
    <path d="M9 17v-4" />
    <path d="M13 17v-4" />
    <path d="M18 20v-5l-4-4V7" />
  </svg>
);

export const BadgeCheck = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Quote = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M16 3a5 5 0 0 0-4 7.25l2.25 5.75H12L10.5 21h6l1.5-5H16a3 3 0 0 1 0-6h1V3ZM4 10a3 3 0 0 1 3-3h1V3H5a5 5 0 0 0-4 7.25l2.25 5.75H1L-.5 21h6l1.5-5H5a3 3 0 0 1 0-6Z" />
  </svg>
);
...
export const ClipboardList = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Box = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Play = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
